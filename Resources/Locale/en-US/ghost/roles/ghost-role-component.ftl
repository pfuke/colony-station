...
ghost-role-information-nukeop-rules = You are a revolutionary warrior tasked with the destruction of the castle. As an antagonist, do whatever is required to complete this task.

ghost-role-information-loneop-name = Lone Operative
ghost-role-information-loneop-description = You are a lone ninja assassin. Kill the nobles and destroy the castle!
ghost-role-information-loneop-rules = You are an elite revolutionary warrior tasked with the destruction of the castle. As an antagonist, do whatever is required to complete this task.
